...
\texttt{-o}).
It records, for every zone, the bands involved, the reference k-point chosen,
the type of reference (\emph{boundary} or \emph{isolated}), the number of
k-points rotated, and the mean and minimum singular values.
