...
\chapter{Getting Started}\label{ch:introduction}
...
Chapter \nameref{ch:workflow} explains what each script does, what parameters are required and what options they have.
...
\chapter{Flowchart}
\includepdf[scale=1]{figures/berry_flow_chart.pdf}


\chapter{Algorithm of \emph{cluster} script}
\label{cha:cluster}

Algorithm of \emph{cluster} script
