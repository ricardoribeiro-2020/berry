...
When the \texttt{n-workers} option is greater than one and the in-memory
...
\hline
  ...
  \texttt{-n-workers}                & Number of parallel workers (default: 1) \\
  \texttt{-o file\_path}             & Name of output log file \\
