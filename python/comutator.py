...
def comute(berryConnection, sprime, s, beta, alpha):
    ...
    e = berryConnection[sprime_s][beta]*berryConnection[s_sprime][alpha] \
...
def comute3(berryConnection, sprime, s, r, beta, alpha2, alpha1):
    ...
    e = berryConnection[sprime_s][beta]*berryConnection[s_r][alpha2]*berryConnection[r_sprime][alpha1] \
      + berryConnection[sprime_r][alpha1]*berryConnection[r_s][alpha2]*berryConnection[s_sprime][beta]
...
#    sprime_s = str(sprime) + ' ' + str(s)
    ...
    e = a[alpha2] - 1j*(berryConnection[s_s][alpha2] - berryConnection[sprime_sprime][alpha2]) \
...
def comutederiv(berryConnection, s, sprime, beta, alpha1, alpha2, dk):
    ...
    e = berryConnection[sprime_s][beta]*deriv(berryConnection, s, sprime, alpha1, alpha2, dk) \
       -deriv(berryConnection, sprime, s, alpha1, alpha2, dk)*berryConnection[s_sprime][beta] 
